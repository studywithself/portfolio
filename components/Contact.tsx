...
export default function Contact() {
  return (
    <section
      id="Contact"
      className="h-full py-10 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 relative"
    >
      <div className="max-w-5xl mx-auto px-6 w-full">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-[2.5rem] overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row min-h-[500px]">
          ...
          <div className="w-full md:w-5/12 bg-white dark:bg-gray-700/30 p-10 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-700">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-bold text-lg mb-8 tracking-wide">
            ...
            <div className="flex gap-4 w-full justify-center">
              <a
                ...
                className="p-3 bg-gray-900 text-white rounded-xl hover:bg-gray-700 transition-all hover:-translate-y-1 shadow-md hover:shadow-lg"
                aria-label="Github"
              >
                <FaGithub size={24} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-[#20c997] text-white rounded-xl hover:bg-[#12b886] transition-all hover:-translate-y-1 shadow-md hover:shadow-lg"
                aria-label="Velog"
              >
                <SiVelog size={24} />
              </a>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="group flex items-center gap-6 p-5 rounded-2xl bg-white dark:bg-gray-700/50 border border-gray-100 dark:border-gray-600 hover:border-blue-200 dark:hover:border-blue-500/30 transition-all shadow-sm hover:shadow-md">
                ...
                <div className="flex-1 overflow-hidden">
                  <p className="text-xs text-gray-500 dark:text-gray-400 font-bold mb-1 uppercase tracking-wider">
                    Email
                  </p>
                  <a
                    href="mailto:dla5420@naver.com"
                    className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors block truncate"
                  >
                    dla5420@naver.com
                  </a>
                </div>
